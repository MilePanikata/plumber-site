      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <nav className="hidden md:flex items-center gap-8">
            ...
            <a href="#" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors" data-testid="link-services">SERVICES</a>
            ...
            <a href="#" className="text-sm font-medium text-muted-foreground hover:text-primary transition-colors" data-testid="link-contact">CONTACT</a>
          </nav>
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden py-4 border-t border-border" data-testid="nav-mobile-menu">
            <div className="flex flex-col gap-4">
              ...
              <a href="#" className="text-sm font-medium text-muted-foreground">SERVICES</a>
              <a href="#" className="text-sm font-medium text-muted-foreground">BLOG</a>
              <a href="#" className="text-sm font-medium text-muted-foreground">CONTACT</a>
