...
export default function Hero() {
  return (
    <section className="relative min-h-[85vh] bg-navy-dark overflow-hidden">
      ...
      <Settings className="absolute top-20 left-10 w-32 h-32 text-primary/10 rotate-12" />
      <Settings className="absolute bottom-20 right-10 w-40 h-40 text-primary/10 -rotate-12" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6 lg:px-8 relative z-10">
        <div className="grid md:grid-cols-2 gap-8 lg:gap-12 items-center min-h-[85vh] py-16">
          ...
          <div className="grid grid-cols-2 gap-4 relative">
            ...
            <div className="bg-muted/10 backdrop-blur-sm rounded-lg p-6 border border-white/10">
            ...
            <div className="bg-muted/10 backdrop-blur-sm rounded-lg p-6 border border-white/10 flex flex-col items-center justify-center">
              <div className="w-12 h-12 bg-white/10 rounded-full flex items-center justify-center mb-2">
                <svg className="w-6 h-6 text-orange" viewBox="0 0 24 24" fill="currentColor">
                  <path d="M12 2L15.09 8.26L22 9.27L17 14.14L18.18 21.02L12 17.77L5.82 21.02L7 14.14L2 9.27L8.91 8.26L12 2Z" />
                </svg>
              </div>
              <p className="text-xs font-semibold text-white text-center">Committed to high quality services</p>
            </div>
          </div>
        </div>
      </div>
